...
namespace CardsServer.BLL.Abstractions
{
    public interface IUserService
    {
        ...
        Task<Result<GetUserSimpleResponse>> GetByUserName(string userName,  CancellationToken cancellationToken);
        // Task<Result<GetUserFullResponse>> GetUser(int userId, CancellationToken cancellationToken);
        Task<Result<GetUserSimpleResponse>> GetUser(int userId, CancellationToken cancellationToken);
    }
}